...
extern "C" {
  ...
  void ufbint(int bufr_unit, void* c_data, int* dim_1, int* dim_2, int* iret, const char* table_b_mnemonic);
  void ufbret(int bufr_unit, void* c_data, int* dim_1, int* dim_2, int* iret, const char* table_b_mnemonic);
