...
program intest4
  ...
  If (ierme .ne. 0 .or. cmgtag .ne. 'MSTTB001' .or. imgdt .ne. 2016041815 ) stop 5
  ...
  if (nr8lv .ne. 180 .or. nint(r8arr(1,12)) .ne. 86 .or. nint(r8arr(1,15)) .ne. 38 .or. &
       ...
       nint(r8arr2(1,12)*10) .ne. 6 .or. nint(r8arr2(1,33)*10) .ne. 4) stop 8
  ...
  if (ier1 .ne. 0 .or. ier2 .ne. 0 .or. ier3 .ne. 0 .or. tag1 .ne. 'TMBRST  ' .or. &
       ...
       tag3 .ne. 'RDNE    ' .or. ntag3 .ne. 10) stop 9
