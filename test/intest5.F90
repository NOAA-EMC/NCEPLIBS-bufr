...
!
! Testing reading IN_5, with OPENBF IO = IN and LUNIN = LUNDX
...
program intest5
  ...
  if (ier2 .ne. 0 .or. lcmg2 .ne. 34 .or. &
       cmeang2(1:lcmg2) .ne. 'Surface pressure observation error') stop 3
  
  call getcfmng(11, 'GSES', 10, ' ', -1, cmeang3, lcmg3, ier3)
  if (ier3 .ne. 3 .or. lcmg3 .ne. 24 .or. &
       cmeang3(1:lcmg3) .ne. 'GCLONG  OGCE    ORIGC   ') stop 4

  call getcfmng(11, 'GSES', 10, 'GCLONG', 173, cmeang4, lcmg4, ier4)
  if (ier4 .ne. 0 .or. lcmg4 .ne. 20 .or. &
       cmeang4(1:lcmg4) .ne. 'Stennis Space Center') stop 5
