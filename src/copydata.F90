...
!>
!> @param[in] lunin - Fortran logical unit number for source BUFR file
!> @param[in] lunot - Fortran logical unit number for target BUFR file
!>
...
!> units.
!>
!> @param[in] lui - File ID for source BUFR file
!> @param[in] luo - File ID for target BUFR file
...
!> subroutine bort().
!>
!> @param[in] lunit - Fortran logical unit number for BUFR file associated with output unit
!> @param[in] lin - File ID for input unit
!> @param[in] lun - File ID for output unit
!> @param[in] ibyt - Length (in bytes) of data subset
!>
...
!>
!> @param[in] lubin - Fortran logical unit number for source BUFR file
!> @param[in] lubot - Fortran logical unit number for target BUFR file
!>
!> @author J. Woollen @date 1994-01-06
...
!>
!> @param[in] lud - File ID for input unit
!> @param[in] lun - File ID for output unit
!>
!> @author Woollen @date 1994-01-06
