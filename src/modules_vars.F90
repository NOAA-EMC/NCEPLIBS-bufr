...
module modv_vars
  ...
  !> Master table version number for the last BUFR message that was read from a logical
  ...
  !> Local table version number for the last BUFR message that was read from a logical
  !> unit where Section 3 decoding is being used.
  integer :: lmtvl
