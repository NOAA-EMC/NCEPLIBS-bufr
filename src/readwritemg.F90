...
!> @param[out] subset - character*8: Table A mnemonic for type of BUFR message that was read
!> (see [DX BUFR Tables](@ref dfbftab) for further information about Table A mnemonics)
!> @param[out] jdate - integer: Date-time stored within Section 1 of BUFR message that was read, in format of either
...
!> @param[out] subset - character*8: Table A mnemonic for type of BUFR message that was read
!> (see [DX BUFR Tables](@ref dfbftab) for further information about Table A mnemonics)
!> @param[out] idate - integer: date-time stored within Section 1 of BUFR message that was read,
!> in format of either YYMMDDHH or YYYYMMDDHH, depending on the most recent call to subroutine datelen()
!> @returns ireadmg - integer: Return code:
!> - 0 = new BUFR message was successfully read into internal arrays
...
!> @param[out] jdate - integer: Date-time stored within Section 1 of BUFR message that was read,
...
!>
!> @param[in] lunit - integer: Fortran logical unit number for BUFR file
!> @param[in] subset - character*(*): Table A mnemonic for type of BUFR BUFR message to be opened
!> (see [DX BUFR Tables](@ref dfbftab) for further information about Table A mnemonics)
!> @param[in] jdate - integer: Date-time to be stored within Section 1 of BUFR message being opened,
...
!>
!> @param[in] lunit - integer: Fortran logical unit number for BUFR file
!> @param[in] subset - character*(*): Table A mnemonic for type of BUFR message to be opened
!> (see [DX BUFR Tables](@ref dfbftab) for further information about Table A mnemonics)
!> @param[in] jdate - integer: Date-time to be stored within Section 1 of BUFR message being opened,
!> in format of either YYMMDDHH or YYYYMMDDHH
!>
...
!>
!> @param[in] msiz - integer: Size (in bytes) of current BUFR message
!> @param[in] itoadd - integer: Size (in bytes) of current data subset
!> @param[in] mxsiz - integer: Maximum size of a BUFR message
!> @returns msgfull - logical: Flag indicating whether the current data subset will fit within the current BUFR message
!>
