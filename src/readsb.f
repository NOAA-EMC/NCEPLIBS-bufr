...
C> internal arrays within the BUFRLIB software. From there it can
...
C> subsets available within the current message; a new call needs
C> to be made to one of the [message-reading subroutines](@ref hierarchy)
