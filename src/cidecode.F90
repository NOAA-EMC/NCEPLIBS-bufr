...
!> @param[in] nchr - integer: Number of bytes of ibay from within which to decode chr (i.e. the number of characters in chr)
...
!> @param[in] cnvnull - logical: .true. if null characters in ibay should be converted to blanks within chr; .false. otherwise
!>
!> @author J. Woollen @date 1994-01-06
...
!> @param[in] ibit - integer: Bit within ibay after which to begin decoding nval
!> @param[in] nbits - integer: Number of bits to be decoded
!> @param[out] nval - integer: Decoded value
!>
!> @author J. Woollen @date 1994-01-06
...
!>
!> @param[in] mbay - integer(*): Array containing encoded value
!> @param[in] nbyt - integer: Byte within mbay at whose first bit to begin decoding
!> @param[in] nbit - integer: Number of bits to be decoded, up to a maximum of 32
!>
!> @returns iupb - integer: Decoded value
!>
!> @author J. Woollen @date 1994-01-06
...
!>
!> @param[in] cbay - character*4: String
!> @param[in] nbits - integer: Number of bits from cbay to be decoded, up to a maximum of 32
!>
!> @returns iupm - integer: Decoded value
!>
!> @author J. Woollen @date 1994-01-06
