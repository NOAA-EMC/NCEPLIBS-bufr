...
C> Initialize, within the internal arrays, a new
C> uncompressed BUFR message for output. Arrays are filled in common
C> block msgptr and modules @ref moda_msgcwd and @ref moda_bitbuf.
C>
